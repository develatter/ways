...
SDD is deprecated: open new work with /ways-outcome instead, and use this only to finish an active SDD work or when the human explicitly asks for SDD. Existing SDD work completes under its original workflow and assurance policies.
